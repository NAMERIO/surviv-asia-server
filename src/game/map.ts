import { ObjectKind, CollisionType, type Orientation, GameMode } from "../utils/constants";
import { log, deepCopy } from "../utils/misc";
import { Config, Debug, Maps, Objects } from "../utils/data";
import {
    type MinMax,
    random,
    distanceBetween,
...
export class GameMap {
    ...
    constructor(game: Game, mapId: string) {
        ...
        if (!Debug.disableMapGeneration) {
            ...
            this.genOnShore(ObjectKind.Obstacle, "barrel_01", 9, 57, 4);
