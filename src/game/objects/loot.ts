import { Constants, ObjectKind, WeaponType } from "../../utils/constants";
...
export class Loot extends GameObject {
    ...
    constructor(game: Game,
        ...
        this.body = game.world.createBody({
            type: "dynamic",
            position: position || Vec2(0, 0), // Ensure a default position if not provided
            linearDamping: 0.003
        });
    ...
    interact(p: Player): void {
        ...
        if (this.typeString.endsWith("scope")) {
            ...
            if (canDualWield && p.weapons[0].typeId === this.typeId) {
                ...
                p.weapons[0].customClip = Weapons[gunTypeString].maxClip;
                slotSwitchingTo = 0;
                ...
                if (p.activeWeapon.typeString === this.typeString) ignore = true;
                    ...
                    (p.activeWeapon as Gun).customClip = Weapons[this.typeString].maxClip;
